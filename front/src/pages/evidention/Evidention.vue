<template>
  <v-container fluid grid-list-sm>
    <v-toolbar color="White">
      <v-toolbar-title class="headline">{{$t('drawer.work_area')}}</v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <!---------------------------------- Details item Dialog  ----------------------------------------->
    <details-item
      @refreshEvidentions="readTableData(api)"
...
<script>
  ...
  import AddEvidention from "../../components/evidention/AddEvidention";
  import EditEvidention from "../../components/evidention/EditEvidention";
  import DetailsEvidention from "../../components/evidention/DetailsEvidention";


  export default {
    name: "Evidention",
    components: {
      'add-item': AddEvidention,
      'edit-item': EditEvidention,
      'details-item': DetailsEvidention,
