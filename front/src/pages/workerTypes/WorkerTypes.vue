...
<script>
    ...
    import AddWorkerType from "../../components/workerTypes/AddWorkerType";
    import EditWorkerType from "../../components/workerTypes/EditWorkerType";


    export default {
        name: "WorkerTypes",
        components: {
            'add-item': AddWorkerType,
            'edit-item': EditWorkerType,
        },
        data() {
            return {
                breakpoint: 500,
