...
<script>
    ...
    import DialogAddAccount from "../user/DialogAddAccount";
    import DialogEditAccount from "../user/DialogEditAccount";
    ...
    export default {
        ...
        components: {
            'add-item': DialogAddAccount,
            'edit-item': DialogEditAccount,
        },
        data() {
            return {
                breakpoint: 500,
        ...
        computed: {
            headers() {
                return [
                    {text: this.$t(this.translation+'.number'), name: 'account_number', align: 'left', value: 'account_number'},
                    {text: this.$t(this.translation+'.bank'), name: 'bankName', align: 'left', value: 'bank.name'},
