...
<script>
  ...
  import AddPartner from "../../components/user/AddPartner";
  import EditPartner from "../../components/user/EditPartner";
  import DetailsPartner from "../../components/user/DetailsPartner";
    ...
    computed: {
      headers() {
        return [
          ...
          {text: this.$t(this.translation + '.address'), name: 'address', align: 'left', value: 'address'},
          {text: this.$t(this.translation + '.pib'), name: 'pib', align: 'left', value: 'pib'},
          {text: this.$t(this.translation + '.pdv'), name: 'pdv', align: 'left', value: 'pdv'},
          {text: this.$t(this.translation + '.type'), name: 'partner_type', align: 'left', value: 'partner_type.name'},
