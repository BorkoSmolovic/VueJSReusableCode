...
<script>
    ...
    export default {
        ...
        computed: {
            headers() {
                return [
                    {text: this.$t(this.translation+'.type'), name: 'type', align: 'left', sortable: true, value: 'type'},
                    {text: this.$t(this.translation+'.plates'), name: 'plates', align: 'left', sortable: true, value: 'plates'},
