...
<script>
    ...
    import AddContactType from "../../components/ContactType/AddContactType";
    import EditContactType from "../../components/ContactType/EditContactType";


    export default {
        name: "ContactTypes",
        components: {
            'add-item': AddContactType,
            'edit-item': EditContactType,
        },
        data() {
            return {
                breakpoint: 500,
                translation: 'contact_types',
                api: 'contactType',
                dataForModal: {},
                addItemDialog: false,
