...
<script>
    import {edit, readContactTypesActive} from "../../statics/DataTableFunctions";
    ...
    export default {
        ...
        watch: {
            editItemDialog: function (val) {
                if (val) {
                    this.contactType = this.dataForModal.contact_type;
                    this.form = {
                        contact: this.dataForModal.contact,
                        contact_type_id: this.dataForModal.contact_type_id,
