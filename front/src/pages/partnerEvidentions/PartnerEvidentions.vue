    ...
    >
      ...
      <template v-slot:item.actions="{ item }">
        <v-layout align-center justify-center>
          <v-btn icon @click.stop="openDetailsDialog(item)">
            <v-icon>mdi-account</v-icon>
          </v-btn>
          <v-btn icon :disabled="item.status.status.id>1" @click.stop="openEditDialog(item)">
...
<script>
  ...
  import PartnerEvidentionAdd from "../../components/partnerEvidentions/PartnerEvidentionAdd";
  import PartnerEvidentionEdit from "../../components/partnerEvidentions/PartnerEvidentionEdit";
  import PartnerEvidentionDetails from "../../components/partnerEvidentions/PartnerEvidentionDetails";
  import axios from "axios";


  export default {
    name: "PartnerEvidention",
    components: {
      'add-item': PartnerEvidentionAdd,
      'edit-item': PartnerEvidentionEdit,
      'details-item': PartnerEvidentionDetails,
