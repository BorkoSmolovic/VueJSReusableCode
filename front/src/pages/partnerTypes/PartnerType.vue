...
<script>
    ...
    import AddPartnerType from "../../components/partnerTypes/AddPartnerType";
    import EditPartnerType from "../../components/partnerTypes/EditPartnerType";


    export default {
        name: "PartnerTypes",
        components: {
            'add-item': AddPartnerType,
            'edit-item': EditPartnerType,
        },
        data() {
            return {
                breakpoint: 500,
                translation: 'partner_types',
                api: 'partnerType',
                dataForModal: {},
                addItemDialog: false,
