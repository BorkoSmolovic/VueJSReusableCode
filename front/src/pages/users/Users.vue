        ...
        computed: {
            headers() {
                return [
                    ...
                    {text: this.$t(this.translation+'.username'), name: 'username', align: 'left', sortable: true, value: 'username'},
                    {text: this.$t(this.translation+'.partner_name'), name: 'partnerName', align: 'left', sortable: true, value: 'partner.name'},
