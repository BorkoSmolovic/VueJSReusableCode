...
<script>
    ...
    import DialogAddContact from "../user/DialogAddContact";
    import DialogEditContact from "../user/DialogEditContact";
    ...
    export default {
        ...
        components: {
            'add-item': DialogAddContact,
            'edit-item': DialogEditContact,
        },
        data() {
            return {
                breakpoint: 500,
        ...
        computed: {
            headers() {
                return [
                    {text: this.$t(this.translation+'.contact'), name: 'contact', align: 'left', value: 'contact'},
                    {text: this.$t(this.translation+'.contactType'), name: 'contact_type', align: 'left', value: 'contact_type.name'},
